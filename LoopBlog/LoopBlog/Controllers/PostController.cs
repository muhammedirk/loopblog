...
namespace LoopBlog.Controllers {
    ...
    public class PostController : Controller {
        ...
        public IActionResult Create() {// yeni post oluşturmak için eklenen ıaction
        ...
        [HttpPost]
        public async Task<IActionResult> Add(CreateViewModel createViewModel) {// oluşturulan postu httppost yollamak için
            await postBusinessManager.CreatePost(createViewModel, User);//postmanager içinden gerekli bilgiler alınıyor
